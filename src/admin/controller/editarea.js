...
export default class extends Base {
    ...
    async indexAction() {
        ...
        let getArea = () => {
            ...
            return fn({
                url: areaModule.host +":"+areaModule.port+areaModule.path+"admin/getone",
        ...
        iconUrl = area.icon;
        photosUrl = area.photos;
        big_photosUrl = area.big_photos;
        videosUrl = area.videos;
        this.assign({
            'area':area
        })
        return this.display();
    ...
    async addAction() {
        ...
        let addArea = () => {
            let fn = think.promisify(request.post);
            return fn({
                url: areaModule.host +":"+areaModule.port+areaModule.path+"admin/edit",
                form:{token: token, area_id: area_id, name: name, init_fans: init_fans, tel:tel, status: status,addr:addr, icon:iconUrl, big_photos:big_photos, photos: photos, videos: videos, detail: detail, addr_ll:addr_ll}
            });
        }
